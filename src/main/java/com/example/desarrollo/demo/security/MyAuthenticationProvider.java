package com.example.desarrollo.demo.security;
...
public class MyAuthenticationProvider implements AuthenticationProvider{
	...
	@Autowired
	private MedicoUserRepository userRepository;
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        MedicoUser usuario = userRepository.findByUsuario(username);
	...
	private List<SimpleGrantedAuthority> getAuthorities(MedicoUser usuario) {
